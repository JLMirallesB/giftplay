...
function translatePage() {
    ...
    document.title = translations.page_title || 'GIFTPlay';
...
async function setLanguage(lang) {
    ...
    localStorage.setItem('giftplay_language', lang);
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const savedLang = localStorage.getItem('giftplay_language');
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { setLanguage, t, translatePage };
}
